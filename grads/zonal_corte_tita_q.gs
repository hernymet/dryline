***********************************************************************************
* Corte vertical zonal de temperatura potencial, q y viento bidimensional u, omega*
***********************************************************************************
...
carpeta_salida='/home/hernymet/Documents/figuras_grads/corte_zonal_tita_q/'
...
* Graficamos el vector u;w, tenemos que convertir omega a w primero:
...
'draw title Corte Vertical en lat='latcorte' de Temperatura Potencial (cont. negro, K),\q (somb, g/Kg), omega (cont. rojo, Pa/s) y \vector (u,w*100) (m/s, flechas) 'itime1'.'

*Guardamos la figura
tiempo_guarda=itime2+100
'printim 'carpeta_salida'/'tiempo_guarda''z_corte_tita_q''latcorte''_''itime1'.gif gif white x800 y600'
