...
'set grads off'
'd maskout(smth9(hdivg(q*u,q*v))*86400000,1500-z.2(t=1,z=1)/9.80665)'
...
'define ukt=u*1.943'
'define vkt=v*1.943'
'd skip(maskout(ukt,1500-z.2(t=1,z=1)/9.80665),3);skip(maskout(vkt,1500-z.2(t=1,z=1)/9.80665),3)' 
